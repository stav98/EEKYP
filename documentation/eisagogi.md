...
<p align = "center">
  <img src="../resources/images/programmer.jpg" width="400">
</p>

<p>
  Στο αρχείο pltformio.ini περιγράφεται και το σχήμα διαμόρφωσης της μνήμης Flash 1Mbyte. Η μνήμη χωρίζεται σε δύο blocks των 512Kbyte. Το 1ο καταλαμβάνεται από τον κώδικα που φτάνει στο 73-75% ενώ το δεύτερο διαμορφώνεται με το σύστημα αρχείων LittleFs. Εκεί αποθηκεύονται οι σελίδες HTML, τα αρχεία CSS και JavaScript καθώς και τα αρχεία ρυθμίσεων και καταγραφής. 
</p>
