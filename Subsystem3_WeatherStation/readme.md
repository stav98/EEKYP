...
Με μια σύριγγα στάζουμε νερό στην τραμπάλα και βρίσκουμε τα ml που χρειάζονται για να αλλάξει η κατάσταση. Είδαμε ότι με 3 ml αλλάζει η ισορροπία της τραμπάλας. Επειδή κάνουμε διακοπή στον microcontroller με κάθοδο παλμού τότε για 3ml θα μετρήσει ένα παλμό. Και τώρα λίγοι υπολογισμοί:
...
72,4ml / 3ml = 24 παλμοί.

<table align="center">
 <tr>
  <td>Ύψος</td><td>Όγκος</td><td>Παλμοί</td>
 </tr>
 <tr>
