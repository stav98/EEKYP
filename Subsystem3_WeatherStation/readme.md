...
Με μια σύριγγα στάζουμε νερό στην τραμπάλα και βρίσκουμε τα ml που χρειάζονται για να αλλάξει η κατάσταση. Είδαμε ότι με 3,5 ml κάνει ένα πλήρη κύκλο, δηλαδή 1,75ml στο κάθε άκρο. Επειδή κάνουμε διακοπή στον microcontroller με κάθοδο παλμού τότε για 3,5ml θα μετρήσει δύο παλμούς. Και τώρα λίγοι υπολογισμοί:

Διάμετρος χωνιού 9,6cm δηλαδή ακτίνα 4,8cm δηλαδή εμβαδόν = π*r<sup>2</sup> = 3.14 * 4,8<sup>2</sup> = 72,4cm<sup>2</sup2>.
