...
void setup() 
{
 ...
 readSettings(); //Διάβασε ρυθμίσεις αρχικής οθόνης από SPIFFS και θέσε τις μεταβλητές λειτουργίας
 blink_per = millis();
 ...
 os_timer_arm(&mqttTimer, (unsigned long)(SetMQTT_Per.toFloat() * 60000), true);  //Ενεργοποίηση με επανάληψη κλήσης ώστε να στέλνει στον mqtt broker
 ...
 strcpy(Pressure, "950");
 //Serial.println("rst"); //Κάνε reset το Arduino Nano
}
