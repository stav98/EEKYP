...
void setUserVars(String key, String value)
{
 if (key == "V1")
     ...
     SetA2_OFF = value;
 //Θέση ηλεκτοβάνας για επαναφορά μετά από διακοπή
 else if (key == "S1")
     {
      if (value == "off")
         {
 ...
 if (!file) 
    {
     ...
     //Βάλε αρχικές τιμές στις μεταβλητές
     SetA1_LABL = "Ηλεκτροβάνα 1"; 
     SetA1_TOPIC = "valve1";
     SetA1_ON = "on";
     SetA1_OFF = "off";
     SetA2_LABL = "Ηλεκτροβάνα 2"; 
     SetA2_TOPIC = "valve2";
     SetA2_ON = "on";
     SetA2_OFF = "off";
 ...
 if (!file) 
    {
     ...
     ST_KEY = "";
     IP_STATIC = "false"; //<--
     IP_ADDR = "192.168.42.128"; //192.168.1.100
