 ...
 if (!file) 
    {
     ...
     //Βάλε αρχικές τιμές στις μεταβλητές
     SetA1_LABL = "Διακόπτης 1"; 
     SetA1_TOPIC = "switch1";
     SetA1_ON = "on";
     SetA1_OFF = "off";
     SetA2_LABL = "Διακόπτης 2"; 
     SetA2_TOPIC = "switch2";
     SetA2_ON = "on";
     SetA2_OFF = "off";
     SetMQTT_Per = "1";
 ...
 if (!file) 
    {
     ...
     ST_KEY = "";
     IP_STATIC = "false"; //<--
     IP_ADDR = "192.168.42.129"; //192.168.1.100
     ...
     MQTT_SRV = "xxxxxx.com"; //<-- or ip address
     MQTT_PORT = "1883";
     MQTT_USER = "";
     MQTT_PASS = "";
     MQTT_CLIENT = "EEKYP-2A";
     LOG_NAME = "admin";
     LOG_PASS = "admin";
     //Γράψε το αρχείο την πρώτη φορά μόνο
